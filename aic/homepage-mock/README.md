# AIC homepage mock v2

Self-contained HTML. No build. Open `index.html` in a browser.
...
VPS copy: dated AIC homepage-mock folder `2026-08-29-asca-homepage-v2` on the files host.
